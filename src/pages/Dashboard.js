...
export const Dashboard = () => {
    ...
    const [lastMatchFeedback, setLastMatchFeedback] = useState(null);
    ...
    const handleMatchFeedback = async (outcome) => {
