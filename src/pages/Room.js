...
export const Room = () => {
    ...
    // Avatar do usuário
    const userAvatarUrl = 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=400&auto=format&fit=crop&q=80';
    ...
    const handleIceFallback = async (pc) => {
