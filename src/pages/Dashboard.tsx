  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6] text-[#1C1917] flex flex-col font-sans relative selection:bg-[#1C1917] selection:text-[#FAF9F6]">
      ...
      <main className="flex-1 max-w-5xl w-full mx-auto p-6 lg:p-8 flex flex-col gap-6">
        ...
        {/* Atalho rápido para Conversas / Amigos caso não haja conversas ativas */}
        <section className="bg-[#FFFFFF] border border-[#E7E5E4] rounded-2xl p-6 shadow-sm flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-[#F5F5F4] border border-[#E7E5E4] flex items-center justify-center text-[#1C1917]">
              <svg className="w-5 h-5 fill-none stroke-current stroke-2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.764 9.764 0 01-2.555-.337A5.972 5.972 0 015.41 20.97a5.969 5.969 0 01-.474-.065 4.48 4.48 0 00.978-2.025c.09-.457-.133-.901-.467-1.226C3.93 16.178 3 14.189 3 12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25z" /></svg>
            </div>
            <div className="flex flex-col">
              <span className="text-xs font-black uppercase text-[#1C1917]">Conversas & Mensagens (DM)</span>
              <span className="text-[11px] font-medium text-[#78716C]">Você não possui conversas ativas no momento. Adicione amigos após as sessões para trocar mensagens!</span>
            </div>
          </div>
          <Button variant="primary" onClick={() => { setSelectedChatContact(null); setIsDirectChatsOpen(true); }} className="px-4 py-2.5 text-xs font-bold uppercase tracking-wider bg-[#FAF9F6] border-2 border-[#1C1917] text-[#1C1917] hover:bg-[#F5F5F4] rounded-xl shrink-0">
            Abrir Mensagens
          </Button>
        </section>
